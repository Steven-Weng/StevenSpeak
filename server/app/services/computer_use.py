...
async def main():
    async with LocalPlaywrightComputer(start_url="https://www.google.com") as computer:
        with trace("Computer use example"):
            ...
            demo_query = "latest AI news"
            result = await Runner.run(
                agent,
                f"Search for '{demo_query}' and summarize what you find.",
