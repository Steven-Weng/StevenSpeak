      ...
      switch (type) {
        ...
        case 'client_info': {
          ...
          if (info === 'response_processing') {
            ...
            if (personaRaw === 'joi' || personaRaw === 'officer_k') {
    ...
    <div className="relative min-h-screen overflow-hidden text-stone-100">
      <div className="pointer-events-none absolute inset-0 -z-20">
        <Image
          ...
          alt="StevenSpeak ambient backdrop"
          fill
          priority
          ...
          <div className="flex items-start justify-center gap-8 sm:gap-12">
            ...
            <div className="relative overflow-hidden rounded-[32px] border border-stone-500/35 bg-stone-900/45 p-8 shadow-[0_35px_140px_rgba(2,6,23,0.65)] backdrop-blur-2xl">
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-2">
                {(['joi', 'officer_k'] as const).map((key) => (
                  <button
                    key={key}
                    onClick={() => {
                      setPersona(key);
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-5">
                ...
                <div className="flex flex-col justify-end sm:col-span-2">
                  <div className="rounded-2xl border border-stone-500/30 bg-stone-950/45 px-4 py-3 text-sm text-stone-400">
                    <span className="flex items-center justify-between">
                      <span className="uppercase tracking-[0.35em] text-stone-300">Capture</span>
                      <span className={`uppercase tracking-[0.35em] font-semibold ${isMicLive ? 'text-emerald-200' : isMuted ? 'text-stone-500' : 'text-stone-300'}`}>
